...
public class PostExample implements CommClient, Runnable
{
   public boolean finished = false;

   public static void main(String args[]) throws IOException
   {
      Thread t = new Thread(new PostExample());
   ...
   public void run()
   {
	 ...
	 ByteArrayInputStream data = HttpChannel.encode(ht);
         h.post(new URL("http://skydome/write.cgi?file=tmp/dt"), this, null, data, data.available());
	 await();
	 System.exit(0);
      }
      catch (Exception e)
