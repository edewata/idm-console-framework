...
public class About extends AbstractDialog {
    ...
    Dimension netscape_logoDimension, other_logoDimension;
    String fileLoc;
    ...
    public About(JFrame parent, ResourceSet resourceSet) {
        ...
        try {
            ...
            netscape_logoDimension = new Dimension( Integer.parseInt(
                    _resource.getString("", "netscape_maxWidth")),
                    Integer.parseInt(_resource.getString("", "netscape_maxHeight")));
    ...
    /**
      * Title pane will contain Netscape copyright
      */
    JPanel createTitlePane() {
        JPanel titlePane = new JPanel();
        titlePane.setLayout(new BoxLayout(titlePane, BoxLayout.Y_AXIS));
        titlePane.add(
                createContentPane("netscape", netscape_logoDimension));
        return titlePane;
    }
